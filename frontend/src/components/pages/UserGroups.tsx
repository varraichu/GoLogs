          ...
          >
            ...
            <div style="margin-top: 16px;">
              ...
              <div style="margin-top: 8px;">
                <div class="oj-typography-body-sm oj-sm-margin-bottom-2x">
                  ...
                  {group.applicationCount > MAX_VISIBLE_APPS && (
                    <oj-button onojAction={showMoreApps} chroming="borderless">
                      Show all apps
                    </oj-button>
                  )}
                </div>
            ...
            <div style="margin-top: 16px;" class="oj-flex oj-sm-justify-content-space-between">
              ...
              <oj-button
                display="icons"
                class="oj-sm-margin-end"
                onojAction={() => handleAppAccess(group)}
              >
                App Access
              </oj-button>
              <oj-button
                display="icons"
                chroming="danger"
                onojAction={() => confirmDeleteGroup(group._id)}
              >
                Delete
              </oj-button>
            </div>
        ...
        >
          <div class="oj-dialog-body">
            <oj-c-form-layout>
              ...
              <oj-c-input-text
                labelHint="Add Member Email"
                value={addEmailInput}
                onFocus={() => setActiveInput('add')}
                onvalueChanged={(e) => setAddEmailInput(e.detail.value)}
              ></oj-c-input-text>
              {errors.memberEmails && (
                ...
                {addMemberEmailsList.map((email) => (
                  <div class="oj-flex oj-sm-align-items-center oj-sm-margin-bottom">
                    ...
                    <oj-button
                      display="icons"
                      chroming="borderless"
                      onojAction={() => removeEmail(email, 'add')}
                    >
              ...
              {editingGroup && (
                <>
                  <oj-c-input-text
                    labelHint="Remove Member Email"
                    value={removeEmailInput}
                    onFocus={() => setActiveInput('remove')}
                    onvalueChanged={(e) => setRemoveEmailInput(e.detail.value)}
                  ></oj-c-input-text>
                  <div class="oj-sm-margin-top">
                    {removeMemberEmailsList.map((email) => (
                      <div class="oj-flex oj-sm-align-items-center oj-sm-margin-bottom">
                        ...
                        <oj-button
                          display="icons"
                          chroming="borderless"
                          onojAction={() => removeEmail(email, 'remove')}
                        >
              ...
              {directoryResults.length > 0 && (
                <div class="oj-popup">
                  {directoryResults.map((email) => (
                    <div
                      class="oj-flex oj-sm-align-items-center oj-sm-padding-2x oj-sm-hoverable oj-clickable"
                      onClick={() => selectDirectoryResult(email)}
                    >
                      {email}
                    </div>
                  ))}
          ...
          <div class="oj-dialog-footer">
            ...
            <oj-button onojAction={() => setShowDialog(false)} chroming="borderless">
              Cancel
            </oj-button>
          </div>
        </oj-dialog>
